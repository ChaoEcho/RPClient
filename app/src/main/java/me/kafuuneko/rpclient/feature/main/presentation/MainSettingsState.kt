...
data class MainSettingsState(
    val appearanceState: MainAppearanceSettingsState = MainAppearanceSettingsState(AppThemeMode.FollowSystem),
...
data class MainAppearanceSettingsState(val themeMode: AppThemeMode)
