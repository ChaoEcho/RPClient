...
sealed class GroupChatUiIntent {
    ...
    data class StartReply(val messageId: Long) : GroupChatUiIntent()
    data object CancelReply : GroupChatUiIntent()
    ...
    data class SelectNaturalMaxSpeakers(val count: Int) : GroupChatUiIntent()
    data class SelectAutoModeMaxRounds(val rounds: Int) : GroupChatUiIntent()
    ...
    data class OpenGuidedRegenerate(val messageId: Long) : GroupChatUiIntent()
    data class ChangeGuidedRegenerateDraft(val value: String) : GroupChatUiIntent()
    data object ConfirmGuidedRegenerate : GroupChatUiIntent()
