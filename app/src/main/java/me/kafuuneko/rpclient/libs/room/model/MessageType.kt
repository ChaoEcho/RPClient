...
import me.kafuuneko.rpclient.libs.room.model.MessageType.Companion.fromStableCode
...
enum class MessageType(val stableCode: String) {
    ...
    companion object {
         ...
         */
        fun fromStableCode(code: String): MessageType = entries.firstOrNull {
            it.stableCode == code
        } ?: throw IllegalArgumentException("Unknown message type code: $code")
    }
}
